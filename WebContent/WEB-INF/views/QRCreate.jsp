...
<body>
	...
	<div class="qrInfoDiv">
		...
		<p>层析时间：<input type="text" id="waitt" placeholder="秒"></p>
		<p>过期日期：<input type="text" id="outdate" placeholder="yyyy-mm-dd"></p>
		...
		<p class="fend1P" style="display:none;">临界值1：<input type="text" id="fend1"></p>
		<p class="qu2P" style="display:none;">曲线2：<input type="text" id="qu2_a">x^2  <input type="text" id="qu2_b">x  <input type="text" id="qu2_c"></p>
		<p class="fend2P" style="display:none;">临界值2：<input type="text" id="fend2"></p>
		<p class="qu3P" style="display:none;">曲线3：<input type="text" id="qu3_a">x^2  <input type="text" id="qu3_b">x  <input type="text" id="qu3_c"></p>
